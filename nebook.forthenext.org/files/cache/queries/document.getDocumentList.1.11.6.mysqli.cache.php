...
${'s_member_srls24_argument'} = new ConditionArgument('s_member_srls', $args->s_member_srls, 'in');
${'s_member_srls24_argument'}->createConditionValue();
if(!${'s_member_srls24_argument'}->isValid()) return ${'s_member_srls24_argument'}->getErrorMessage();
} else
${'s_member_srls24_argument'} = NULL;if(${'s_member_srls24_argument'} !== null) ${'s_member_srls24_argument'}->setColumnType('number');
...
,new ConditionWithArgument('`member_srl`',$member_srls11_argument,"in", 'and')
...
,new ConditionWithArgument('`member_srl`',$s_member_srls24_argument,"in", 'or')
