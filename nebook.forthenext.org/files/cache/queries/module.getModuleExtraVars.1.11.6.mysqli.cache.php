...
${'module_srl208_argument'} = new ConditionArgument('module_srl', $args->module_srl, 'in');
${'module_srl208_argument'}->checkNotNull();
${'module_srl208_argument'}->createConditionValue();
...
new ConditionWithArgument('`module_srl`',$module_srl208_argument,"in")))
));
