...
${'site_srl290_argument'} = new ConditionArgument('site_srl', $args->site_srl, 'equal');
${'site_srl290_argument'}->checkNotNull();
${'site_srl290_argument'}->createConditionValue();
if(!${'site_srl290_argument'}->isValid()) return ${'site_srl290_argument'}->getErrorMessage();
if(${'site_srl290_argument'} !== null) ${'site_srl290_argument'}->setColumnType('number');
...
new ConditionGroup(array(
new ConditionWithArgument('`sites`.`site_srl`',$site_srl290_argument,"equal")))
));
