function move_category(form){ return legacy_filter('move_category', form, 'document', 'procDocumentMoveCategory', completeMoveCategory, ['error','message','xml_file','source_category_srl'], 'Are you sure you want to move?', {}) };
(function($){
