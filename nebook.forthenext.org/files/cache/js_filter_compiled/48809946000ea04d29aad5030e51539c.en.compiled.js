function insert_mpage_content(form){ return legacy_filter('insert_mpage_content', form, 'page', 'procPageAdminInsertContent', completeInsertMobilePageContent, ['error','message','mid','module_srl','page'], 'Are you sure you want to submit?', {'content':'mcontent'}) };
(function($){
