function delete_extra_var(form){ return legacy_filter('delete_extra_var', form, 'document', 'procDocumentAdminDeleteExtraVar', completeInsertExtraVar, ['error','message'], 'Are you sure you want to delete?', {}) };
(function($){
