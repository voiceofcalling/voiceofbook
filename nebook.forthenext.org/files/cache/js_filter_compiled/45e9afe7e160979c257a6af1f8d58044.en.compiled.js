function insert_extra_var(form){ return legacy_filter('insert_extra_var', form, 'document', 'procDocumentAdminInsertExtraVar', completeInsertExtraVar, ['error','message'], 'Are you sure you want to submit?', {}) };
(function($){
	...
	v.cast('ADD_MESSAGE',['eid','Name of user defined']);
