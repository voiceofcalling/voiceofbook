...
<div class="x">
	<div class="x_modal-header">
		<h1><?php echo escape($__Context->widget_info->title, false) ?> <?php echo $__Context->lang->cmd_generate_code ?></h1>
	</div>
	<div id="content" class="x_modal-body">
		<p><?php echo escape($__Context->widget_info->description, false) ?> <?php echo $__Context->lang->about_widget_code_in_page ?></p>
			...
			<div class="x_control-group">
				...
				<div class="x_controls">
					<select name="selected_widget" id="selected_widget" style="margin:0">
						<?php if($__Context->widget_list&&count($__Context->widget_list))foreach($__Context->widget_list as $__Context->list_widget_info){ ?><option value="<?php echo escape($__Context->list_widget_info->widget, false) ?>"><?php echo escape($__Context->list_widget_info->title, false) ?></option><?php } ?>
					</select>
