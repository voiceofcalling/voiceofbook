	...
	<table width="100%" border="1" cellspacing="0" summary="List of Articles">
		<thead>
			...
			<tr>
				...
				<?php if($__Context->val->type=='regdate' && $__Context->val->idx==-1){ ?><th scope="col"><span><a href="<?php echo getUrl('sort_index','regdate','order_type',$__Context->order_type) ?>" rel="nofollow"><?php echo $__Context->lang->date ?></a></span></th><?php } ?>
				<?php if($__Context->val->type=='last_update' && $__Context->val->idx==-1){ ?><th scope="col"><span><a href="<?php echo getUrl('sort_index','update_order','order_type',$__Context->order_type) ?>" rel="nofollow"><?php echo $__Context->lang->last_update ?></a></span></th><?php } ?>
				<?php if($__Context->val->type=='last_post' && $__Context->val->idx==-1){ ?><th scope="col"><span><a href="<?php echo getUrl('sort_index','update_order','order_type',$__Context->order_type) ?>" rel="nofollow"><?php echo $__Context->lang->last_post ?></a></span></th><?php } ?>
				<?php if($__Context->val->type=='readed_count' && $__Context->val->idx==-1){ ?><th scope="col"><span><a href="<?php echo getUrl('sort_index','readed_count','order_type',$__Context->order_type) ?>" rel="nofollow"><?php echo $__Context->lang->readed_count ?></a></span></th><?php } ?>
				<?php if($__Context->val->type=='voted_count' && $__Context->val->idx==-1){ ?><th scope="col"><span><a href="<?php echo getUrl('sort_index','voted_count','order_type',$__Context->order_type) ?>" rel="nofollow"><?php echo $__Context->lang->voted_count ?></a></span></th><?php } ?>
				<?php if($__Context->val->type=='blamed_count' && $__Context->val->idx==-1){ ?><th scope="col"><span><a href="<?php echo getUrl('sort_index','blamed_count','order_type',$__Context->order_type) ?>" rel="nofollow"><?php echo $__Context->lang->blamed_count ?></a></span></th><?php } ?>
...
<div class="list_footer">
	<div class="btnArea">
		<a href="<?php echo getUrl('act','dispBoardWrite','document_srl','') ?>" rel="nofollow" class="btn"><i class="xi-pen"></i> <?php echo $__Context->lang->cmd_write ?></a>
		...
		<?php if($__Context->grant->manager){ ?><a class="btn" href="<?php echo getUrl('act','dispBoardAdminBoardInfo') ?>" rel="nofollow" title="<?php echo $__Context->lang->cmd_setup ?>"><i class="xi-cog"></i> <?php echo $__Context->lang->cmd_setup ?></a><?php } ?>			
		<?php if($__Context->grant->manager){ ?><a href="<?php echo getUrl('','module','document','act','dispDocumentManageDocument') ?>" rel="nofollow" class="btn" onclick="popopen(this.href,'manageDocument'); return false;"><?php echo $__Context->lang->cmd_manage_document ?></a><?php } ?>
	</div>
