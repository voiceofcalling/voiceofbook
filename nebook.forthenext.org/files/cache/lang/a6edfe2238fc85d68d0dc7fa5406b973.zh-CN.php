...
$lang->about_domain='要创建一个站点必须有一个专用域名。 一级域名或二级域名皆可。输入的时候请把XE安装路径也一起输入。 ex) www.xpressengine.com/xe';
$lang->about_vid='直接以http://XE安装地址/ID的方式访问。 模块名(mid)不能重复。 模块名要以英文字母开头，且只允许使用英文字母，数字及"_"。';
...
$lang->about_module='除基本library以外XE全部由模块组成。 模块管理中列出所有已安装的模块，因此易于管理。';
