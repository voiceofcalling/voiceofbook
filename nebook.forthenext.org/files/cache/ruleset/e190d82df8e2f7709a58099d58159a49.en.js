...
v.cast('ADD_FILTER',['fileModuleConfig', {'allowed_filesize':{required:true,rule:'float',default:'2'},'allowed_attach_size':{required:true,rule:'float',default:'2'},'allowed_filetypes':{required:true,rule:'extension'}}]);
v.cast('ADD_MESSAGE',['allowed_filesize','Maximum File Size']);
v.cast('ADD_MESSAGE',['allowed_attach_size','Maximum Attachments']);
v.cast('ADD_MESSAGE',['allowed_filetypes','Allowed extentsions']);
