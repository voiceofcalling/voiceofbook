...
$layout_info->title = 'Default Layout';
$layout_info->description = 'Site default layout.';
...
$layout_info->extra_var->LOGO_IMG->title = 'Site logo image';
...
$layout_info->extra_var->LOGO_TEXT->title = 'Site logo text';
...
$layout_info->extra_var->WEB_FONT->title = 'Web Font';
...
$layout_info->extra_var->WEB_FONT->options['NO']->val = 'Do not use \'NanumGothic\' web font';
$layout_info->extra_var->WEB_FONT->options['YES'] = new stdClass;
$layout_info->extra_var->WEB_FONT->options['YES']->val = 'Use \'NanumGothic\' web font';
...
$layout_info->extra_var->VISUAL_USE->title = 'Use visual image and text';
...
$layout_info->extra_var->VISUAL_USE->options['YES']->val = 'Use visual image and text';
$layout_info->extra_var->VISUAL_USE->options['NO'] = new stdClass;
$layout_info->extra_var->VISUAL_USE->options['NO']->val = 'Do not use visual image and text';
$layout_info->extra_var->VISUAL_IMAGE_1 = new stdClass;
$layout_info->extra_var->VISUAL_IMAGE_1->group = NULL;
$layout_info->extra_var->VISUAL_IMAGE_1->title = 'Visual Image 1';
...
$layout_info->extra_var->VISUAL_TEXT_1->title = 'Visual Text 1';
...
$layout_info->extra_var->VISUAL_LINK_1->title = 'Visual Link 1';
...
$layout_info->extra_var->VISUAL_IMAGE_2->title = 'Visual Image 2';
...
$layout_info->extra_var->VISUAL_TEXT_2->title = 'Visual Text 2';
...
$layout_info->extra_var->VISUAL_LINK_2->title = 'Visual Link 2';
...
$layout_info->extra_var->VISUAL_IMAGE_3->title = 'Visual Image 3';
...
$layout_info->extra_var->VISUAL_TEXT_3->title = 'Visual Text 3';
...
$layout_info->extra_var->VISUAL_LINK_3->title = 'Visual Link 3';
...
$layout_info->extra_var->FOOTER->title = 'Site footer text';
...
$layout_info->menu->GNB->title = 'Global Navigation Bar';
